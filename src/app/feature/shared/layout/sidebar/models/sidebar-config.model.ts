...
export const SIDEBAR_MENU: ISidebarItem[] = [
  // ── Facility & structure ──────────────────────────────
  {
    ...
    children: [
      ...
      { id: 'org-departments', label: 'Departments', icon: '🗂️', route: '/layout/home', code: 1700 },
      ...
      { id: 'org-teams', label: 'Teams', icon: '👥', route: '/organization/teams', code: 500 },
      { id: 'org-branches', label: 'Branches', icon: '📍', route: '/organization/branches', code: 1900 },
    ],
  },
