 ...
 //====================Table
  ...
  getTableColumns(): void {
    this.tableColumns = [
      ...
      {
        field: 'companyName',
        name: 'organization.department.table.companyName',
        type: TableHeaderType.String,
      },
      {
        field: 'branchName',
        name: 'organization.department.table.branchName',
        type: TableHeaderType.String,
      },
      {
        field: 'createdAt',
        name: 'organization.department.table.createdAt',
  ...
  onDelete(roleId: string) {
    this.organizationService.onDeleteDepartment(roleId).subscribe({
      next: (res) => {
        console.log(res);
      },
      error: (err) => {
